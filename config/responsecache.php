...
$tag = config('app.tag', 'digitizationacademy');
...
return [
    ...
    'cache' => [
         ...
         */
        'lifetime_in_seconds' => (int) env('RESPONSE_CACHE_LIFETIME', 86400),
